...
# Remove titles for child properties without ref definitions
def exclude_properties_titles(schema: Dict[str, Any], _: Any) -> None:
...
class BaseModel(PydanticBaseModel):
    class Config:
        extra = Extra.forbid
        schema_extra = staticmethod(exclude_properties_titles)
...
# __root__ model is clunky from a pythong user perspective.
